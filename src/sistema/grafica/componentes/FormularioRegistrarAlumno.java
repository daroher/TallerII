		...
		registrarButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String msg = controlador.registrarAlumno(cedulaField.getText(), nombreField.getText(),
							apellidoField.getText(), tipoAlumno, domicilioField.getText(), telefonoField.getText(),
							becaField.getText(), razonBecaField.getText());
